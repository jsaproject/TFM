...
class Tflite {
  ...
  static final List<int> pascalVOCLabelColors = [
    Color.fromARGB(255, 0, 0, 0).toARGB32(), // background
    Color.fromARGB(255, 128, 0, 0).toARGB32(), // aeroplane
    Color.fromARGB(255, 0, 128, 0).toARGB32(), // bicycle
    Color.fromARGB(255, 128, 128, 0).toARGB32(), // bird
    Color.fromARGB(255, 0, 0, 128).toARGB32(), // boat
    Color.fromARGB(255, 128, 0, 128).toARGB32(), // bottle
    Color.fromARGB(255, 0, 128, 128).toARGB32(), // bus
    Color.fromARGB(255, 128, 128, 128).toARGB32(), // car
    Color.fromARGB(255, 64, 0, 0).toARGB32(), // cat
    Color.fromARGB(255, 192, 0, 0).toARGB32(), // chair
    Color.fromARGB(255, 64, 128, 0).toARGB32(), // cow
    Color.fromARGB(255, 192, 128, 0).toARGB32(), // diningtable
    Color.fromARGB(255, 64, 0, 128).toARGB32(), // dog
    Color.fromARGB(255, 192, 0, 128).toARGB32(), // horse
    Color.fromARGB(255, 64, 128, 128).toARGB32(), // motorbike
    Color.fromARGB(255, 192, 128, 128).toARGB32(), // person
    Color.fromARGB(255, 0, 64, 0).toARGB32(), // potted plant
    Color.fromARGB(255, 128, 64, 0).toARGB32(), // sheep
    Color.fromARGB(255, 0, 192, 0).toARGB32(), // sofa
    Color.fromARGB(255, 128, 192, 0).toARGB32(), // train
    Color.fromARGB(255, 0, 64, 128).toARGB32(), // tv-monitor
  ];
